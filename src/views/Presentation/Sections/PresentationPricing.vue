      ...
      <div class="container">
        <div class="row mt-5">
          <SimplePricingCard
            ...
            :specifications="['Complete documentation', 'Full code', 'Projects - 1', 'Team size - 1', 'Support', 'Free Updates - 6 months']"
          />
          ...
          <SimplePricingCard
            ...
            :price="149"
            :specifications="['Complete documentation', 'Full code', 'Projects - 1', 'Team size - up to 5', 'Support', 'Free Updates - 12 months']"
          />
          ...
          <SimplePricingCard
            ...
            :price="599"
            :action="{
              route: 'https://secure.avangate.com/order/checkout.php?PRODS=37189144&OPTIONS37189144=ENTERPRISE&CART=1&CARD=2&CLEAN_CART=1&SHORT_FORM=1',
              label: 'Buy now',
              color: 'bg-gradient-dark',
            }"
            :specifications="[
