        ...
        <div class="col-lg-3">
          <div class="nav-wrapper position-relative end-0">
            <ul class="nav nav-pills nav-fill flex-row p-1" role="tablist">
              <li class="nav-item">
                <a class="nav-link mb-0 px-0 py-1 active" data-bs-toggle="tab" :href="`#preview-${id}`" role="tab" aria-selected="true">
                  <i class="fas fa-desktop text-sm me-2"></i> Preview
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link mb-0 px-0 py-1" data-bs-toggle="tab" :href="`#code-${id}`" role="tab" aria-selected="false">
    ...
    <div class="tab-content tab-space">
      ...
      <div class="tab-pane" :id="`code-${id}`">
        <div class="position-relative p-4 pb-2">
          <a class="btn btn-sm bg-gradient-dark position-absolute end-4 mt-3 z-index-3" @click="copy($event)" href="javascript:;"
